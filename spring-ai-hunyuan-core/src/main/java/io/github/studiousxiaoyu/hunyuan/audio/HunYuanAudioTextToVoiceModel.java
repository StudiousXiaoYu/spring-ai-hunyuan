...
public class HunYuanAudioTextToVoiceModel implements Model<AudioTextToVoicePrompt, AudioTextToVoiceResponse> {
    ...
    public HunYuanAudioTextToVoiceModel(HunYuanAudioApi hunYuanAudioApi) {
        this(hunYuanAudioApi, HunYuanAudioTextToVoiceModelOptions.builder()
                .build());
    }
    ...
    public HunYuanAudioTextToVoiceModel(RetryTemplate retryTemplate, HunYuanAudioApi hunYuanAudioApi, HunYuanAudioTextToVoiceModelOptions options) {
    ...
    public AudioTextToVoiceResponse call(AudioTextToVoicePrompt transcriptionPrompt) {
        ...
        ResponseEntity<HunYuanAudioApi.TextToVoiceResponse> transcriptionEntity = this.retryTemplate
                .execute(ctx -> this.hunYuanAudioApi.createTextToVoice(textToVoiceRequest, HunYuanAudioApi.TextToVoiceResponse.class));
        ...
        AudioTextToVoiceResult transcript = new AudioTextToVoiceResult(transcription.response().audio());
    ...
    private HunYuanAudioApi.TextToVoiceRequest createRequest(AudioTextToVoicePrompt transcriptionPrompt){
        ...
        return HunYuanAudioApi.TextToVoiceRequest.builder().text( instructions)
    ...
    private HunYuanAudioTextToVoiceModelOptions merge(HunYuanAudioTextToVoiceModelOptions source, HunYuanAudioTextToVoiceModelOptions defaultOptions) {
        if (source == null) {
        ...
        merged.setFastVoiceType(source.getFastVoiceType() != null ? source.getFastVoiceType() : defaultOptions.getFastVoiceType());
        merged.setPrimaryLanguage(source.getPrimaryLanguage() != null ? source.getPrimaryLanguage() : defaultOptions.getPrimaryLanguage());
        ...
        merged.setEnableSubtitle(source.getEnableSubtitle() != null ? source.getEnableSubtitle() : defaultOptions.getEnableSubtitle());
        merged.setSegmentRate(source.getSegmentRate() != null ? source.getSegmentRate() : defaultOptions.getSegmentRate());
        merged.setEmotionCategory(source.getEmotionCategory() != null ? source.getEmotionCategory() : defaultOptions.getEmotionCategory());
        merged.setEmotionIntensity(source.getEmotionIntensity() != null ? source.getEmotionIntensity() : defaultOptions.getEmotionIntensity());
        return merged;
    }
