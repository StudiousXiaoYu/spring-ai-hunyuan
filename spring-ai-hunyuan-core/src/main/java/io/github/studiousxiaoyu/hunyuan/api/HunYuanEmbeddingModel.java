...
public class HunYuanEmbeddingModel extends AbstractEmbeddingModel {
	...
	public HunYuanEmbeddingModel(HunYuanApi hunYuanApi, MetadataMode metadataMode, HunYuanEmbeddingOptions options) {
		this(options, RetryUtils.DEFAULT_RETRY_TEMPLATE, hunYuanApi, metadataMode);
	}

	public HunYuanEmbeddingModel(HunYuanEmbeddingOptions options, RetryTemplate retryTemplate, HunYuanApi hunYuanApi,
