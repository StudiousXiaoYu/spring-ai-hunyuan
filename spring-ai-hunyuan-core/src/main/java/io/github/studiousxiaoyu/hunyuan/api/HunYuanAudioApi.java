...
public class HunYuanAudioApi {
	...
	public HunYuanAudioApi(String baseUrl, String secretId, String secretKey) {
		this(baseUrl, secretId, secretKey, HunYuanConstants.DEFAULT_TRANSCRIPTION_ACTION);
	}
	...
	public HunYuanAudioApi(String baseUrl, String secretId, String secretKey, String action) {
		...
		this(baseUrl, secretId, secretKey, action, HunYuanConstants.DEFAULT_TRANSCRIPTION_SERVICE,
				HunYuanConstants.DEFAULT_TRANSCRIPTION_HOST, HunYuanConstants.DEFAULT_TRANSCRIPTION_VERSION);
	}

	public HunYuanAudioApi(String baseUrl, String secretId, String secretKey, String action, String service,
			String host, String version) {
		this(baseUrl, secretId, secretKey, action, service, host, version, RestClient.builder(),
				RetryUtils.DEFAULT_RESPONSE_ERROR_HANDLER);
	}

	public HunYuanAudioApi(String baseUrl, String secretId, String secretKey, String action, String service,
			String host, String version, RestClient.Builder restClientBuilder,
	...
	public ResponseEntity<TranscriptionResponse> createTranscription(TranscriptionRequest request,
			Class<TranscriptionResponse> transcriptionResponseClass) {
		...
		TranscriptionResponse transcriptionResponse = ModelOptionsUtils.jsonToObject(response.getBody(),
				transcriptionResponseClass);
		return ResponseEntity.ok(transcriptionResponse);
	}

	public ResponseEntity<TextToVoiceResponse> createTextToVoice(TextToVoiceRequest textToVoiceRequest,
			Class<TextToVoiceResponse> audioTextToVoiceResponseClass) {
		ResponseEntity<String> response = this.restClient.post()
			.uri("/")
			.body(textToVoiceRequest)
			.retrieve()
			.toEntity(String.class);
		TextToVoiceResponse textToVoiceResponse = ModelOptionsUtils.jsonToObject(response.getBody(),
				audioTextToVoiceResponseClass);
	...
	public record TranscriptionRequest(@JsonProperty("EngSerViceType") String engSerViceType,
			@JsonProperty("SourceType") Integer sourceType, @JsonProperty("VoiceFormat") String voiceFormat,
			@JsonProperty("Url") String url, @JsonProperty("Data") String data,
			@JsonProperty("DataLen") Integer dataLen, @JsonProperty("WordInfo") Integer wordInfo,
			@JsonProperty("FilterDirty") Integer filterDirty, @JsonProperty("FilterModal") Integer filterModal,
			@JsonProperty("FilterPunc") Integer filterPunc, @JsonProperty("ConvertNumMode") Integer convertNumMode,
			@JsonProperty("HotwordId") String hotwordId, @JsonProperty("CustomizationId") String customizationId,
			@JsonProperty("HotwordList") String hotwordList, @JsonProperty("InputSampleRate") String inputSampleRate) {
	...
	@JsonInclude(Include.NON_NULL)
	public record TextToVoiceRequest(@JsonProperty("Text") String text, @JsonProperty("SessionId") String sessionId,
			@JsonProperty("Volume") Float volume, @JsonProperty("Speed") Float speed,
			@JsonProperty("ProjectId") Integer projectId, @JsonProperty("ModelType") Integer modelType,
			@JsonProperty("VoiceType") Integer voiceType, @JsonProperty("FastVoiceType") String fastVoiceType,
			@JsonProperty("PrimaryLanguage") Integer primaryLanguage, @JsonProperty("SampleRate") Integer sampleRate,
			@JsonProperty("Codec") String codec, @JsonProperty("EnableSubtitle") Boolean enableSubtitle,
			@JsonProperty("SegmentRate") Integer segmentRate, @JsonProperty("EmotionCategory") String emotionCategory,
		...
		public static class Builder {
			...
			public TextToVoiceRequest build() {
				return new TextToVoiceRequest(text, sessionId, volume, speed, projectId, modelType, voiceType,
						fastVoiceType, primaryLanguage, sampleRate, codec, enableSubtitle, segmentRate, emotionCategory,
						emotionIntensity);
			}
	...
	// @formatter:off
			@JsonProperty("Response") TextToVoiceDetail response
	) {
		// @formatter:on
	}
	...
	public record TextToVoiceDetail(@JsonProperty("Audio") String audio, @JsonProperty("SessionId") String sessionId,
		...
		public record Subtitle(@JsonProperty("Text") String text, @JsonProperty("BeginTime") Integer beginTime,
				...
				@JsonProperty("EndIndex") Integer endIndex, @JsonProperty("Phoneme") String phoneme) {
		}
	}
