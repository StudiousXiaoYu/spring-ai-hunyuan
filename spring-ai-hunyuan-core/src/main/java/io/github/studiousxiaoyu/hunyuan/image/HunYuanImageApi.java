...
import io.github.studiousxiaoyu.hunyuan.api.HunYuanStreamFunctionCallingHelper;
...
public class HunYuanImageApi {
	...
	private static final Logger logger = LoggerFactory.getLogger(HunYuanImageApi.class);
	 ...
	 */
	public HunYuanImageApi(String secretId, String secretKey) {
	 ...
	 * @param secretKey Hunyuan SecretKey.
	 */
	public HunYuanImageApi(String baseUrl, String secretId, String secretKey) {
		this(baseUrl, secretId, secretKey, HunYuanConstants.DEFAULT_CHAT_ACTION, RestClient.builder(),
				RetryUtils.DEFAULT_RESPONSE_ERROR_HANDLER);
	}

	public HunYuanImageApi(String baseUrl, String secretId, String secretKey, String action) {
	 ...
	 */
	public HunYuanImageApi(String baseUrl, String secretId, String secretKey, RestClient.Builder restClientBuilder,
	...
	public Flux<ChatCompletionChunk> chatCompletionStream(ChatCompletionRequest chatRequest) {
		...
		MultiValueMap<String, String> jsonContentHeaders = hunYuanAuthApi
			.getHttpHeadersConsumerByRequest(HunYuanConstants.DEFAULT_CHAT_ACTION, chatRequest);
	...
	public <T> EmbeddingList embeddings(EmbeddingRequest<T> embeddingRequest) {
		...
		ResponseEntity<EmbeddingResponse> embeddingResponseResponseEntity = this.restClient.post()
			.uri("/")
			.header("X-TC-Action", HunYuanConstants.DEFAULT_EMBED_ACTION)
