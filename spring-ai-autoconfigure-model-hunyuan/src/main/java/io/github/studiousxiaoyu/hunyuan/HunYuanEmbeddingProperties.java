...
public class HunYuanEmbeddingProperties extends HunYuanParentProperties {
	...
	/**
	 * Enable HunYuan embedding model.
	 */
	...
	private HunYuanEmbeddingOptions options = HunYuanEmbeddingOptions.builder().model(DEFAULT_EMBEDDING_MODEL).build();

	public HunYuanEmbeddingOptions getOptions() {
		return this.options;
	}

	public void setOptions(HunYuanEmbeddingOptions options) {
