...
public class HunYuanAudioTranscriptionModel implements Model<AudioTranscriptionPrompt, AudioTranscriptionResponse> {
    ...
    public HunYuanAudioTranscriptionModel(RetryTemplate retryTemplate, HunYuanAudioApi hunYuanAudioApi, HunYuanAudioTranscriptionModelOptions options) {
    ...
    public AudioTranscriptionResponse call(AudioTranscriptionPrompt transcriptionPrompt) {
        ...
        ResponseEntity<HunYuanAudioApi.TranscriptionResponse> transcriptionEntity = this.retryTemplate
                .execute(ctx -> this.hunYuanAudioApi.createTranscription(request, HunYuanAudioApi.TranscriptionResponse.class));
    ...
    private HunYuanAudioTranscriptionModelOptions merge(HunYuanAudioTranscriptionModelOptions source, HunYuanAudioTranscriptionModelOptions defaultOptions) {
        if (source == null) {
        ...
        merged.setFilterModal(source.getFilterModal() !=null ? source.getFilterModal() : defaultOptions.getFilterModal());
        merged.setHotwordId(source.getHotwordId() !=null ? source.getHotwordId() : defaultOptions.getHotwordId());
        merged.setHotwordList(source.getHotwordList() !=null ? source.getHotwordList() : defaultOptions.getHotwordList());
        merged.setInputSampleRate(source.getInputSampleRate() !=null ? source.getInputSampleRate() : defaultOptions.getInputSampleRate());
        merged.setWordInfo(source.getWordInfo() !=null ? source.getWordInfo() : defaultOptions.getWordInfo());
        merged.setVoiceFormat(source.getVoiceFormat() !=null ? source.getVoiceFormat() : defaultOptions.getVoiceFormat());
        return merged;
    }
