...
public class HunYuanAudioTextToVoiceModelOptions {
	...
	public final boolean equals(Object o) {
		if (!(o instanceof HunYuanAudioTextToVoiceModelOptions that))
			return false;

		return Objects.equals(text, that.text) && Objects.equals(sessionId, that.sessionId)
				&& Objects.equals(volume, that.volume) && Objects.equals(speed, that.speed)
				&& Objects.equals(projectId, that.projectId) && Objects.equals(modelType, that.modelType)
				&& Objects.equals(voiceType, that.voiceType) && Objects.equals(fastVoiceType, that.fastVoiceType)
				&& Objects.equals(primaryLanguage, that.primaryLanguage) && Objects.equals(sampleRate, that.sampleRate)
				&& Objects.equals(codec, that.codec) && Objects.equals(enableSubtitle, that.enableSubtitle)
				&& Objects.equals(segmentRate, that.segmentRate)
				&& Objects.equals(emotionCategory, that.emotionCategory)
